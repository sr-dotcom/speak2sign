...
def main():
    ...
    lines = ["<!-- generated by scripts/coverage_report.py; do not edit by hand -->", "# Rule-pass coverage", "", f"Lexicon: {len(L)} attested concepts. Content tokens exclude dropped function words.", "",
