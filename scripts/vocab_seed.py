...
NEWS = {
    ...
    "common": "common, usual", "right": "right, correct, proper", "pope": "pope, vatican", "church": "church, religion",
    ...
    "immigration": "immigration, immigrant, migrant", "citizen": "citizen", "manage": "manage, run (organisation), lead, navigated",
